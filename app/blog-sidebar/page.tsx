...
export const metadata: Metadata = {
  title: "Blog Details",
  description: "This is Blog Details Page for Save the Grove Again",
  // other metadata
};
...
const BlogSidebarPage = () => {
  return (
    <>
      <div class="overflow-hidden pb-[120px] pt-[180px]">
        <div class="container">
          <div class="-mx-4 flex flex-wrap">
            <div class="w-full px-4 lg:w-8/12">
              <div>
                <h1 class="mb-8 text-3xl font-bold leading-tight text-black sm:text-4xl sm:leading-tight">
                  10 amazing sites to download stock photos & digital assets for
                  free
                </h1>
                <div class="mb-10 flex flex-wrap items-center justify-between border-b border-body-color border-opacity-10 pb-4">
                  <div class="flex flex-wrap items-center">
                    <div class="mb-5 mr-10 flex items-center">
                      <div class="mr-4">
                      ...
                      <div class="w-full">
                        <span class="mb-1 text-base font-medium text-black">
                          By <span> Musharof Chy</span>
                        </span>
                      </div>
                    </div>
                    <div class="mb-5 flex items-center">
                      <p class="mr-5 flex items-center text-base font-medium text-black">
                        <span class="mr-3">
                          <svg
                            width="15"
                            height="15"
                ...
                <div>
                  ...
                  <h3 class="font-xl mb-10 font-bold leading-tight text-black sm:text-2xl sm:leading-tight lg:text-xl lg:leading-tight xl:text-2xl xl:leading-tight">
                  ...
                  <ul class="mb-10 list-inside list-disc text-black">
                    <li class="mb-2 text-base font-medium text-black sm:text-lg lg:text-base xl:text-lg">
                  ...
                  <div class="items-center justify-between sm:flex">
                    <div class="mb-5">
                      <h4 class="mb-3 text-sm font-medium text-black">
                        Popular Tags :
                      </h4>
                    ...
                    <div class="mb-5">
                      <h5 class="mb-3 text-sm font-medium text-black sm:text-right">
                        Share this post :
                      </h5>
            ...
            <div class="w-full px-4 lg:w-4/12">
              <div class="shadow-three mb-10 mt-12 rounded-sm bg-white p-6 lg:mt-0">
                <div class="flex items-center justify-between">
                  <input
                    type="text"
                    placeholder="Search here..."
                    class="border-stroke mr-4 w-full rounded-sm border bg-[#f8f8f8] px-6 py-3 text-base text-black outline-none transition-all duration-300 focus:border-primary"
                  />
                  <button
                    aria-label="search button"
                    class="flex h-[50px] w-full max-w-[50px] items-center justify-center rounded-sm bg-primary text-white"
                  >
                    <svg
                      width="20"
                      height="18"
              ...
              <div class="shadow-three mb-10 rounded-sm bg-white">
                <h3 class="border-b border-body-color border-opacity-10 px-8 py-4 text-lg font-semibold text-black">
                  Related Posts
                </h3>
                <ul class="p-8">
                  <li class="mb-6 border-b border-body-color border-opacity-10 pb-6">
                    <RelatedPost
              ...
              <div class="shadow-three mb-10 rounded-sm bg-white">
                ...
                <ul class="px-8 py-6">
                  <li>
                    <a
                      href="#0"
                      class="mb-3 inline-block text-base font-medium text-black hover:text-primary"
                    >
                      Tailwind Templates
                    </a>
                  </li>
