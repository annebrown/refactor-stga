                ...
                <div class="container">
                    <div class="-mx-4 flex flex-wrap justify-center">
                        <div class="w-full px-4 lg:w-8/12">
                            <h2 class="mb-8 text-3xl font-bold leading-tight text-black sm:text-4xl sm:leading-tight text-center">
                            STGA Launch Event
                            </h2>
                            ...
                            <div class="text-center px-20">
                                ...
                                <h2 class="my-8 text-3xl font-bold leading-tight text-black sm:text-4xl sm:leading-tight">
                                    What&apos;s Next?
                                </h2>
                                <p class="text-left py-2">
                                ...
                                <p class="text-left py-2">
                                    Subscribe to our <a class="text-green-600" href="https://docs.google.com/forms/d/e/1FAIpQLSfBFJHDmUnmpGv1XaSHGaSSPmGizbxrQ-KgeqRRZqdVNZeuHg/viewform">mailing list</a> to get the latest updates, announcements and events
                                </p>
                                <p class="text-left py-2">
                                    We have set up a volunteer form. If you would like to offer your help please take a few minutes to fill in the <a  class="text-green-600" href="https://docs.google.com/forms/d/e/1FAIpQLSc611weSVb3qvnl6KJd6AZ_lmRn0yStEYDpxIkE9bVJhFTeUQ/viewform?usp=sf_link">form</a>.
                                </p>
                                <p class="text-left py-2">
                                    Take a moment to sign the <a class="text-green-600"  href="https://www.change.org/p/save-the-grove-again-7292e6ca-eb8e-426a-8809-0bb608f24120">online petition</a> (please note that donations through change.org do not come directly to our cause, please send an e-transfer to&nbsp;
