...
const crossIcon = (
  <svg width="7" height="7" viewBox="0 0 8 8" class="fill-current">
...
const OfferList = ({
  ...
  return (
    <div class="mb-3 flex items-center">
      <span class="mr-3 flex h-[18px] w-full max-w-[18px] items-center justify-center rounded-full bg-primary bg-opacity-10 text-primary">
        {status === "active" ? checkIcon : crossIcon}
      </span>
      <p class="m-0 text-base font-medium text-black">{text}</p>
    </div>
  );
};
