...
<!-- Relative -->
<div class="relative z-10 overflow-hidden pb-16 pt-36 md:pb-20 lg:pb-28 lg:pt-[180px]">
            ...
            <div class="w-full px-4">
                ...
                <div class="shadow-three mx-auto max-w-[500px] rounded bg-(--ui-bg) px-6 py-10 sm:p-[60px]">
                    ...
                    >
                        ...
                        Sign in with Google
                    </button><!-- Button - Sign in with google -->

                    <!-- Button - Sign in with GH -->
                        ...
                        <div class="mb-8 flex">
                            ...
                            >
                                <div class="relative">
                                    ...
                                    <div class="box mr-4 mt-1 flex h-5 w-5 
                                        items-center justify-center rounded 
                                        border border-body-color 
                                        border-opacity-20"
                                    >
