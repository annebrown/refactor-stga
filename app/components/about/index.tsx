...
const About = () => {
  return (
    <>
      <div id="About" class=" z-30 mt-0 p-0 w-full text-black">
          
            <h2 class="text-3xl pb-3 font-bold text-center">Our Mission</h2>
            <div class="text-center px-20">
                ...
                <p class="text-left py-2">
                    See <a href="/faq" class=" text-green-600">Frequently Asked Questions</a> for more information.
                </p>
            </div>
