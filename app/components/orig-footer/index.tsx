...
const Footer = () => {
  return (
    <>
        <footer class="relative z-10 w-full b-0 m-0">
                ...
                <div class="flex flex-row m-0 p-0 pt-0 ">
                    ...
                    <div class="shrink m-0 p-0 pb-3">
                        ...
                        <NuxtLink href="/" class="inline-block m-0 p-0 pl-2w-40 h-5 align-top">
                            <Image
                    ...
                    <div class="flex-none inline-block mx-auto text-black items-center m-0 mb-1 p-0 pb-0">
                        <p class="text-center text-sm m-0 p-0"><strong>
                            Contacts
                        </strong></p>
                            ...
                            <span class="flex mx-auto">
                                ...
                                <a href="mailto:savethegroveagain@gmail.com" 
                                    ...
                                    <svg 
                                        ...
                                        width="18" height="18" 
                                        class="inline-block align-bottom mt-1.5"
                                        viewBox="0 0 24 24">
                                            <path 
                                                fill="#38AF34" 
                                ...
                                >
                                    <svg
                                        ...
                                        height="14"
                                        viewBox="0 0 18 14"
                                        class="inline-block align-middle fill-current mt-0 pt-1"
                                        >
                                ...
                                >
                                    ...
                                    fill="none"
                                    xmlns="http://www.w3.org/2000/svg"
                                    class="mt-1 inline-block align-middle fill-green-600 stroke-green-600"
                    ...
                    <div class="flex-none text-black w-fit h-auto pb-1 ">
                        <div class="container mb-0  text-right">
                            ...
                            <ul>
                                <li class="mb-0 pb-0 text-xs">
                                <Link
                                    href="/blog"
                                    class="text-xs text-center duration-300 hover:text-primary text-green-600">
                                    Blog
                                </Link>
                                </li>
                                ...
                                <Link
                                    href="/action"
                                    class="text-xs duration-300 hover:text-primary text-green-600">
                                    Get Involved!
                                </Link>
                                </li>
                ...
                <div class="pb-5 pt-0  w-full rounded-b-lg">
                    <p class="text-center text-xs text-black">
                        Copyright <NuxtLink href="/flyer">@</Link> 2024 Save the Grove Again
                    </p>
                </div>
