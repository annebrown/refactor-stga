            ...
            <div class="w-full px-4 lg:w-8/12">
              <div>
                ...
                Save the Grove Again Information Session- Planting the Seed
                    ...
                    <p><strong>Event Description:</strong></p><br></br>
                    ...
                    <span class="mb-10 text-base font-medium leading-relaxed sm:text-lg sm:leading-relaxed lg:text-base lg:leading-relaxed xl:text-lg xl:leading-relaxed">
                        <ul>
                            <li>- 🗞️Subscribe to our <ULink class="text-(--ui-secondary)" to="https://docs.google.com/forms/d/e/1FAIpQLSfBFJHDmUnmpGv1XaSHGaSSPmGizbxrQ-KgeqRRZqdVNZeuHg/viewform">mailing list</ULink></li>
                            <li>- 💰Make a <ULink class="text-(--ui-secondary)"  to="https://savethegroveagain.com/donations">donation</ULink></li>
                            <li>- 🖋️Sign our <ULink class="text-(--ui-secondary)"  to="https://www.change.org/p/save-the-grove-again-7292e6ca-eb8e-426a-8809-0bb608f24120">online petition</ULink></li>
