          ...
          <div class="-mx-4 flex flex-wrap justify-center">
            <div class="w-full px-4 lg:w-8/12">
                ...
                <div class="text-black font-bold text-lg ">
                  ...
                  <p class="mb-10 text-base font-medium leading-relaxed">
                    ...
                    <div class="rounded-lg grid grid-cols-1 gap-x-8 gap-y-10 h-full ">
                        ...
                        <div class="rounded-lg w-full bg-white p-5">
                            <p class="text-wrap">
                                ...
                                <ULink to="https://www.omilacombe.ca" class="text-green-500">
                                    www.omilacombe.ca
                                </ULink><br/>
                                Attention: Provincial Council members<br/>
                                <ULink to="mailto:information@omilacombe.ca" class="text-(--ui-secondary)">
                                    information@omilacombe.ca<br/>
                                </ULink>
                                <ULink to="tel:6132302225" class="text-(--ui-secondary)">(613)230-2225</ULink><br/>
                            </p>
                        </div>
                        <div class="rounded-lg w-full bg-white p-5">
                            <p class="text-wrap">
                                ...
                                <ULink to="https://www.galileecentre.com" class="text-green-500">
                                    www.galileecentre.com
                                </ULink><br/>
                                Board President: David Perrin<br/>
                                <ULink to="mailto:communications@galileecentre.com" class="text-(--ui-secondary)">
                        ...
                        <div class="rounded-lg w-full bg-white p-5">
                            <p class="text-wrap">
                                ...
                                <ULink to="https://www.thomascavanagh.ca" class="text-green-500">
                                    www.thomascavanagh.ca
                                </ULink><br/>
                                Owner: Jeff Cavanagh<br/>
                                Contact: Pierre Dufresne<br/>
                                <ULink to="mailto:pdufresne@thomascavanagh.ca" class="text-(--ui-secondary)">
                                    pdufresne@thomascavanagh.ca<br/>
                                </ULink>
                                <ULink to="tel:6132572918" class="text-(--ui-secondary)">(613)257-2918</ULink><br/>
                            </p>
                        </div>
                    </div>
                </div><br />
<hr class="border-[#165D8F] border-1" /><br />
                  ...
                  <p class="mb-8 text-base font-medium leading-relaxed sm:text-lg sm:leading-relaxed lg:text-base lg:leading-relaxed xl:text-lg xl:leading-relaxed">In writing to Cavanagh we suggest that you address the concerns about the health and longevity of the Grove and that you impress the rarity of this old growth ecosystem. Please also include any personal reasons that you oppose them purchasing this land to develop. 
                  </p>
...
We also have a new page up on our website called <ULink to="https://savethegroveagain.com/action" class="duration-300 hover:text-primary text-(--ui-secondary)">Get Involved!</ULink>  You can find more contact information for municipal, provincial and federal governments here. We will continue to update it. If you have any suggestions for additions please reach out and let us know. 
                  ...
                  <p class="text-center pb-10 text-2xl weight-bold pt-4 text-(--ui-primary) ">Together we can find a better way!</p>
