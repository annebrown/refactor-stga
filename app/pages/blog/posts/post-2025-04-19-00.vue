...
<div class="w-full mx-auto">
    ...
    <p class="mb-8 text-center text-green-600">
    ...
    <p class="mb-8 text-justify">
        As a non-partisan organization made up of voters from all political backgrounds, <i>Save The Grove Again</i> will never endorse any candidate. Our goal is simply to inform voters about where candidates stand on the proposed development adjacent to Gillies Grove.
    </p>
    ...
    <h2 class="font-extrabold text-lg mb-8 text-[#165D8F]">
        Danilo Velasquez, Green Party
    </h2>

    <h3 class="font-bold mb-8 text-justify text-green-600">
        Are you aware of our grassroots efforts, and what is your position on the matter?  
    </h3>

    <p class="mb-8 text-justify">
        Yes indeed, I am now more aware of the <i>Save The Grove Again</i> organization thanks to my friends, their supporters, and their efforts to protect the Gillies Grove and its woodland. As a firm believer in protecting the environment and my concerns about climate change, I indeed, without hesitation and a shadow of doubt, do support the initiative and efforts of <i>Save The Grove Again</i> to protect and preserve the green space and this treasured land of the community. This green space not only serves as a healing corner for members of the community but is also a habitat for wildlife.
    </p>
    ...
    <p class="mb-8 text-justify">             
        If elected, as a Member of the Parliament and another concerned member of the community, I commit to amplifying your voices to the parliament and making sure that <i>Save The Grove Again</i> is well known at the parliament level and Canada-wide. I commit to bringing these concerns and efforts to the House of Commons and the Minister of Environment and Climate Change at the federal, provincial, and municipal governments, if needed, to review the regulations and make changes necessary to protect the environment and pressure developers to eliminate development and respect the green space and environment-protected lands.
    </p>
    ...
    <p class="mb-8 text-justify">
        When I was door-knocking in Arnprior I had seen various houses with <i>Save The Grove Again</i> signs on display. I did not understand the campaign at the time, but I have now studied the<i> STGA</i> website and consulted a handful of Ottawa Valley citizens for their opinions. At this time, however, my policy comments will remain limited.  For legislators to intervene on issues pertaining to the private sale of land, there arguably must be a case that there is a market externality whereby members of the public are unduly affected in their quality of life by developments in which they are at risk of having no input.  At the same time, it is reasonable for the public to informally judge private market transactions for which information thereof was obtained through reasonable means, including transactions and developments that have not yet been completed.
    </p>
    ...
    <h2 class="font-extrabold text-[#165D8F] text-lg mb-8">
