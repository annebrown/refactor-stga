...
<!-- All Blogs -->
   <!-- All Posts -->
   <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-x-4 gap-y-8 p-4 rounded-4xl
        w-full bg-(--ui-bg) dark:bg-(--ui-primary-2)
...
<!-- 
 border-t-(--ui-secondary-2) dark:border-t-(--ui-primary)
