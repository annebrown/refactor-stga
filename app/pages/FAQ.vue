        ...
        Frequently Asked Questions
            ...
            <div class="flex-col columns-1 md:columns-2 col-gap-10 row-gap-4 m-8">
                ...
                <div class="p-4 break-inside-avoid-column bg-(--ui-color-testimonials) rounded-md mb-4">
                    ...
                    <div class="my-5 mr-5 w-full">
                        <img src="/images/answer/map.svg" alt="map" loading="eager" priority width={1301} height={1148} />
                    </div>
                </div>
                    
                <div class="p-4 break-inside-avoid-column bg-(--ui-color-testimonials) rounded-md mt-4 mb-4">
