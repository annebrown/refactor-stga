          ...
          <div class="-mx-4 flex flex-wrap justify-center">
            <div class="w-full px-4 lg:w-8/12">
                ...
                <div class="text-black">
                    ...
                    <p class="text-center mt-5 pb-10 text-2xl weight-bold pt-4 text-[#165D8F] ">
                        Together we can find a better way!
                    </p>

                    <p class="mt-5 weight-bold text-xl pt-4">
                        Get Involved!
                    </p>
                    <p class="mb-8 text-base font-medium leading-relaxed text-black sm:text-lg sm:leading-relaxed lg:text-base lg:leading-relaxed xl:text-lg xl:leading-relaxed">
...
613 257-2918 <br /><br /> 
Find out about other ways that you can <a href="/action" class="duration-300 hover:text-primary text-green-600">make a difference</a>.  <br /></p>
