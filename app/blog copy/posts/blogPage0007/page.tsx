        ...
        <div class="container">
            ...
            >
                <div class="mb-5 flex flex-wrap items-center justify-between border-b border-body-color border-opacity-10 pb-4">
                    ...
                    <p class="mb-8 mt-8">
                        We would like to take a moment to thank all the local businesses, <NuxtLink href={"#LocalBusinesses"}class="duration-300 hover:text-primary text-green-600">listed below</Link> for their support in sharing posters and selling buttons, the media coverage we’ve received, and the community members who are writing letters, initiating conversations and showing their support with lawn signs. We couldn’t do it without YOU! Thank you
                    </p>
                    <p class="mb-8 mt-8">
                    ...
                    <p class="mb-8 text-center">
                        <span class="font-bold">Ottawa Valley Coffee</span><br />32 Elgin St. W.
                    </p>
                    <p class="mb-8 text-center">
                    <span class="font-bold">Remax Office</span><br />215 Daniel St. S.
                    </p>
                    <p class="mb-8 text-center">
                    <span class="font-bold">Ultimate Fitness Gym</span><br />4-53 James St
                    </p>
                    <p class="mb-8 text-center">
                    <span class="font-bold">Tina’s Hair Shop</span><br />57C Madawaska St.
                    </p>
                    <p class="mb-8 text-center">
                    <span class="font-bold">The Vintage Crate</span><br />159 John St. N.
                    </p>
                    <p class="mb-8 text-center">
